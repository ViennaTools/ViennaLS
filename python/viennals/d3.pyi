...
class ReactionBoundarySample:
    ...
    def distance(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
    @property
    def nodeIndex(self) -> typing.Annotated[list[int], "FixedSize(3)"]:
        ...
    @nodeIndex.setter
    def nodeIndex(self, arg1: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(3)"]) -> None:
        ...
class Reader:
    @typing.overload
    def __init__(self) -> None:
