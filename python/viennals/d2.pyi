...
__all__: list[str] = ['Advect', 'BooleanOperation', 'Box', 'BoxDistribution', 'CalculateCurvatures', 'CalculateNormalVectors', 'CalculateVisibilities', 'Check', 'CompareArea', 'CompareChamfer', 'CompareCriticalDimensions', 'CompareNarrowBand', 'CompareSparseField', 'CompareVolume', 'ConvexHull', 'CustomSphereDistribution', 'Cylinder', 'DetectFeatures', 'Domain', 'Expand', 'FinalizeStencilLocalLaxFriedrichs', 'FromMesh', 'FromSurfaceMesh', 'FromVolumeMesh', 'GeometricAdvect', 'GeometricAdvectDistribution', 'MakeGeometry', 'MarkVoidPoints', 'Oxidation', 'OxidationConstrainedAmbient', 'OxidationCouplingParameters', 'OxidationDeformation', 'OxidationDeformationParameters', 'OxidationDiffusion', 'OxidationMaskBending', 'OxidationMaskParameters', 'OxidationModel', 'OxidationParameters', 'OxidationPresets', 'Plane', 'PointCloud', 'PrepareStencilLocalLaxFriedrichs', 'Prune', 'ReactionBoundarySample', 'Reader', 'Reduce', 'RemoveStrayPoints', 'Sphere', 'SphereDistribution', 'StencilLocalLaxFriedrichsScalar', 'ToDiskMesh', 'ToHullMesh', 'ToMesh', 'ToMultiSurfaceMesh', 'ToSurfaceMesh', 'ToVoxelMesh', 'WriteVisualizationMesh', 'Writer', 'computeLOCOSOpenWindowConservation', 'hrleGrid']
class Advect:
    @typing.overload
...
class BooleanOperation:
    ...
    def __init__(self, arg0: Domain, arg1: Domain) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: Domain, arg1: viennals._core.BooleanOperationEnum) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: Domain, arg1: Domain, arg2: viennals._core.BooleanOperationEnum) -> None:
        ...
    def apply(self) -> None:
        """
...
class CompareCriticalDimensions:
    ...
    def __init__(self, arg0: Domain, arg1: Domain) -> None:
        ...
    def addRange(self, measureDimension: typing.SupportsInt | typing.SupportsIndex, minBounds: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(2)"], maxBounds: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(2)"], findMaximum: bool = True) -> None:
        """
...
class Domain:
    ...
    def __init__(self, gridDelta: typing.SupportsFloat | typing.SupportsIndex = 1.0) -> None:
        ...
    @typing.overload
    def __init__(self, bounds: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(4)"], boundaryConditions: typing.Annotated[collections.abc.Sequence[viennals._core.BoundaryConditionEnum], "FixedSize(2)"], gridDelta: typing.SupportsFloat | typing.SupportsIndex = 1.0) -> None:
        ...
    @typing.overload
...
class FromSurfaceMesh:
    ...
    def setRemoveBoundaryTriangles(self, arg0: bool) -> None:
        ...
        """
    @typing.overload
    def setRemoveBoundaryTriangles(self, arg0: typing.Annotated[collections.abc.Sequence[bool], "FixedSize(3)"]) -> None:
        """
        Set whether to include mesh elements outside of the simulation domain.
        """
class FromVolumeMesh:
    ...
    def __init__(self, arg0: hrleGrid, arg1: viennals._core.Mesh) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: hrleGrid, arg1: viennals._core.Mesh, arg2: bool) -> None:
        ...
    def apply(self) -> None:
        """
...
class MakeGeometry:
    ...
    def setIgnoreBoundaryConditions(self, arg0: bool) -> None:
        ...
    @typing.overload
    def setIgnoreBoundaryConditions(self, arg0: typing.Annotated[collections.abc.Sequence[bool], "FixedSize(3)"]) -> None:
        ...
    def setLevelSet(self, arg0: Domain) -> None:
        """
...
class Oxidation:
    ...
    def applyCFLLimited(self, requestedTime: typing.SupportsFloat | typing.SupportsIndex, cflFactor: typing.SupportsFloat | typing.SupportsIndex) -> float:
        ...
        """
    def getDeformationField(self) -> OxidationDeformation:
        ...
    def getDiffusionField(self) -> OxidationDiffusion:
        ...
    def getLastMaxVelocity(self) -> float:
        """
        Maximum interface velocity (µm/hr) from the most recent CFL step.
        """
    def getMaskBendingField(self) -> OxidationMaskBending:
        ...
    def getMaskCouplingIterations(self) -> int:
        ...
    def getMaskCouplingResidual(self) -> float:
        ...
    def setAmbientInterface(self, arg0: Domain) -> None:
        ...
    def setCouplingParameters(self, arg0: viennals._core.OxidationCouplingParameters) -> None:
        ...
    def setDeformationParameters(self, arg0: viennals._core.OxidationDeformationParameters) -> None:
        ...
    def setGpuMode(self, mode: viennals._core.GpuMode) -> None:
        ...
    def setGpuPreconditioner(self, preconditioner: viennals._core.GpuPreconditioner) -> None:
        ...
    def setMaskBendingBounds(self, minIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"], maxIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"]) -> None:
        ...
    def setMaskCouplingIterations(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    def setMaskCouplingTolerance(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
    def setMaskInterface(self, arg0: Domain) -> None:
        ...
    def setMaskParameters(self, arg0: viennals._core.OxidationMaskParameters) -> None:
        ...
    def setOxidationParameters(self, arg0: viennals._core.OxidationParameters) -> None:
        ...
    ...
    def setTemporalScheme(self, arg0: viennals._core.TemporalSchemeEnum) -> None:
        ...
class OxidationConstrainedAmbient(viennals._core.VelocityField):
    def __init__(self, deformationField: OxidationDeformation, maskVelocityField: OxidationMaskBending, maskInterface: Domain, maskSign: typing.SupportsInt | typing.SupportsIndex = 1) -> None:
        ...
class OxidationDeformation(viennals._core.VelocityField):
    def __init__(self, reactionInterface: Domain, ambientInterface: Domain, diffusionField: OxidationDiffusion, oxidationParameters: viennals._core.OxidationParameters, deformationParameters: viennals._core.OxidationDeformationParameters = ...) -> None:
        ...
    def apply(self) -> None:
        ...
    ...
    def clearMaskInterface(self) -> None:
        ...
    def clearMaskVelocityField(self) -> None:
        ...
    ...
    def getVonMisesStress(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(3)"]) -> float:
        ...
    def markGeometryChanged(self) -> None:
        ...
    def setAmbientInterface(self, arg0: Domain) -> None:
        ...
    def setDeformationParameters(self, arg0: viennals._core.OxidationDeformationParameters) -> None:
        ...
    def setDiffusionField(self, arg0: OxidationDiffusion) -> None:
        ...
    def setMaskInterface(self, maskInterface: Domain, maskSign: typing.SupportsInt | typing.SupportsIndex = 1) -> None:
        ...
    def setMaskVelocityField(self, arg0: viennals._core.VelocityField) -> None:
        ...
    def setOxidationParameters(self, arg0: viennals._core.OxidationParameters) -> None:
        ...
    ...
    def setSolveBounds(self, minIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"], maxIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"]) -> None:
        ...
    def writeFieldsToLevelSet(self) -> None:
        ...
class OxidationDiffusion(viennals._core.VelocityField):
    def __init__(self, reactionInterface: Domain, ambientInterface: Domain, parameters: viennals._core.OxidationParameters = ...) -> None:
        ...
    def apply(self) -> None:
        ...
    def clearMaskInterface(self) -> None:
    ...
    def getConcentration(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(3)"]) -> float:
        ...
    def getConcentrationCache(self) -> dict[int, float]:
        ...
    ...
    def getNumberOfSolutionNodes(self) -> int:
        ...
    def getParameters(self) -> viennals._core.OxidationParameters:
        ...
    def getReactionBoundarySample(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(3)"]) -> ReactionBoundarySample:
        ...
    def getResidual(self) -> float:
        ...
    def getScalarVelocityFromSample(self, arg0: ReactionBoundarySample) -> float:
        ...
    def markGeometryChanged(self) -> None:
        ...
    def markSolved(self) -> None:
        ...
    def setAmbientInterface(self, arg0: Domain) -> None:
        ...
    def setConcentrationCache(self, arg0: collections.abc.Mapping[typing.SupportsInt | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex]) -> None:
        ...
    def setMaskInterface(self, maskInterface: Domain, maskSign: typing.SupportsInt | typing.SupportsIndex = 1) -> None:
        ...
    def setOxideSigns(self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    def setParameters(self, arg0: viennals._core.OxidationParameters) -> None:
        ...
    ...
    def setSolveBounds(self, minIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"], maxIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"]) -> None:
        ...
    def writePersistentFields(self) -> None:
        ...
class OxidationMaskBending(viennals._core.VelocityField):
    @typing.overload
    def __init__(self, deformationField: OxidationDeformation, maskParameters: viennals._core.OxidationMaskParameters = ...) -> None:
        ...
    @typing.overload
    def __init__(self, deformationField: OxidationDeformation, maskInterface: Domain, maskParameters: viennals._core.OxidationMaskParameters = ..., maskSign: typing.SupportsInt | typing.SupportsIndex = 1) -> None:
        ...
    def apply(self) -> None:
        ...
    def clearSolveBounds(self) -> None:
    ...
    def getIterations(self) -> int:
        ...
    def getLastApplyVelocityChange(self) -> float:
        ...
    def getNumberOfContactNodes(self) -> int:
        ...
    def getNumberOfFixedNodes(self) -> int:
        ...
    def getNumberOfSolutionNodes(self) -> int:
        ...
    def getParameters(self) -> viennals._core.OxidationMaskParameters:
        ...
    def getResidual(self) -> float:
        ...
    def setAmbientInterface(self, ambientInterface: Domain, ambientSign: typing.SupportsInt | typing.SupportsIndex = -1) -> None:
        ...
    def setMaskInterface(self, maskInterface: Domain, maskSign: typing.SupportsInt | typing.SupportsIndex = 1) -> None:
        ...
    def setParameters(self, arg0: viennals._core.OxidationMaskParameters) -> None:
        ...
    def setSolveBounds(self, minIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"], maxIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"]) -> None:
        ...
    def writeFieldsToLevelSet(self) -> None:
...
class OxidationModel:
    def __init__(self, diffusionField: OxidationDiffusion, deformationField: OxidationDeformation, couplingParameters: viennals._core.OxidationCouplingParameters = ...) -> None:
        ...
    def apply(self) -> None:
        ...
    def clearSolveBounds(self) -> None:
    ...
    def getResidual(self) -> float:
        ...
    def setDeformationField(self, arg0: OxidationDeformation) -> None:
        ...
    def setDiffusionField(self, arg0: OxidationDiffusion) -> None:
        ...
    def setParameters(self, arg0: viennals._core.OxidationCouplingParameters) -> None:
        ...
    def setSolveBounds(self, minIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"], maxIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"]) -> None:
        ...
class Plane:
...
class PointCloud:
    def __init__(self, arg0: collections.abc.Sequence[typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(2)"]]) -> None:
        ...
    def insertNextPoint(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(2)"]) -> None:
        ...
class Prune:
    @typing.overload
    def __init__(self) -> None:
...
class ReactionBoundarySample:
    ...
    def concentration(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
    @property
    def crossingAxis(self) -> int:
        ...
    @crossingAxis.setter
    def crossingAxis(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    @property
    def crossingOffset(self) -> int:
        ...
    @crossingOffset.setter
    def crossingOffset(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    @property
    ...
    def distance(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
    @property
    def nodeIndex(self) -> typing.Annotated[list[int], "FixedSize(2)"]:
        ...
    @nodeIndex.setter
    def nodeIndex(self, arg1: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"]) -> None:
        ...
class Reader:
    @typing.overload
    def __init__(self) -> None:
...
class ToMesh:
    ...
    def __init__(self, arg0: Domain, arg1: viennals._core.Mesh, arg2: bool) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: Domain, arg1: viennals._core.Mesh, arg2: bool, arg3: bool) -> None:
        ...
    def apply(self) -> None:
        """
        Convert the levelset to a surface mesh.
...
class ToVoxelMesh:
    ...
    def __init__(self, arg0: Domain, arg1: viennals._core.Mesh) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: collections.abc.Sequence[Domain], arg1: viennals._core.Mesh) -> None:
        ...
    def apply(self) -> None:
        """
        Convert the levelset to a surface mesh.
...
class hrleGrid:
    pass
def FinalizeStencilLocalLaxFriedrichs(levelSets: collections.abc.Sequence[Domain]) -> None:
    ...
def PrepareStencilLocalLaxFriedrichs(levelSets: collections.abc.Sequence[Domain], isDepo: collections.abc.Sequence[bool]) -> None:
    ...
def computeLOCOSOpenWindowConservation(siInitial: Domain, siAfter: Domain, ambientInitial: Domain, ambientAfter: Domain, xMin: typing.SupportsFloat | typing.SupportsIndex, xMax: typing.SupportsFloat | typing.SupportsIndex, jMin: typing.SupportsInt | typing.SupportsIndex, jMax: typing.SupportsInt | typing.SupportsIndex, expansionCoefficient: typing.SupportsFloat | typing.SupportsIndex) -> viennals._core.LOCOSConservationDiagnostics:
    ...
