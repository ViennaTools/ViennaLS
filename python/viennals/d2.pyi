...
class OxidationProcessPresets:
    ...
    def wet1000CDealGrove100() -> OxidationParameters:
        ...
    @staticmethod
    def oxideMechanics1000C(arg0: typing.SupportsFloat | typing.SupportsIndex) -> OxidationDeformationParameters:
        ...
    @staticmethod
    def siliconNitrideMask1000C() -> OxidationMaskParameters:
        ...
class ReactionBoundarySample:
    """Sub-grid crossing data returned by OxidationDiffusionVelocityField.getReactionBoundarySample."""
    def __init__(self) -> None:
        ...
    found: bool
    distance: float
    ...
    crossingAxis: int
    crossingOffset: int
    nodeIndex: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(2)"]
...
class OxidationDeformationVelocityField(viennals._core.VelocityField):
    ...
    def setMaskInterface(self, maskInterface: Domain, maskSign: typing.SupportsInt | typing.SupportsIndex = ...) -> None:
        ...
    def setOxidationParameters(self, arg0: OxidationParameters) -> None:
        ...
    def setDeformationParameters(self, arg0: OxidationDeformationParameters) -> None:
        ...
    def setOxideSigns(self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
class OxidationMaskAnchorMode(enum.IntEnum):
    NONE: typing.ClassVar[OxidationMaskAnchorMode]
    MIN_BOUNDARY: typing.ClassVar[OxidationMaskAnchorMode]
    MAX_BOUNDARY: typing.ClassVar[OxidationMaskAnchorMode]
    BOTH_BOUNDARIES: typing.ClassVar[OxidationMaskAnchorMode]
...
class OxidationMaskBendingVelocityField(viennals._core.VelocityField):
    ...
    def getLastApplyVelocityChange(self) -> float:
        ...
    def setAmbientInterface(self, ambientInterface: Domain, ambientSign: typing.SupportsInt | typing.SupportsIndex = ...) -> None:
        ...
    def setMaskInterface(self, maskInterface: Domain, maskSign: typing.SupportsInt | typing.SupportsIndex = ...) -> None:
        ...
...
class OxidationConstrainedAmbientVelocityField(viennals._core.VelocityField):
    def __init__(self, deformationField: OxidationDeformationVelocityField, maskVelocityField: OxidationMaskBendingVelocityField, maskInterface: Domain, maskSign: typing.SupportsInt | typing.SupportsIndex = ...) -> None:
        ...
...
class LOCOSOxidation:
    ...
    def setDeformationParameters(self, arg0: OxidationDeformationParameters) -> None:
        ...
    def setCouplingParameters(self, arg0: OxidationCouplingParameters) -> None:
        ...
    def setMaskParameters(self, arg0: OxidationMaskParameters) -> None:
        ...
    def setSpatialScheme(self, arg0: viennals._core.SpatialSchemeEnum) -> None:
        ...
    def setTemporalScheme(self, arg0: viennals._core.TemporalSchemeEnum) -> None:
    ...
    def getDiffusionField(self) -> OxidationDiffusionVelocityField:
        ...
    def getDeformationField(self) -> OxidationDeformationVelocityField:
        ...
    def getMaskBendingField(self) -> OxidationMaskBendingVelocityField:
        ...
