...
class Domain:
    ...
    def __init__(self, gridDelta: typing.SupportsFloat = 1.0) -> None:
        ...
    @typing.overload
    def __init__(self, bounds: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(4)"], boundaryConditions: typing.Annotated[collections.abc.Sequence[viennals._core.BoundaryConditionEnum], "FixedSize(2)"], gridDelta: typing.SupportsFloat = 1.0) -> None:
        ...
    @typing.overload
...
class Plane:
    def __init__(self, origin: collections.abc.Sequence[typing.SupportsFloat], normal: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
class PointCloud:
    def __init__(self, arg0: collections.abc.Sequence[typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(2)"]]) -> None:
        ...
    def insertNextPoint(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(2)"]) -> None:
        ...
class Prune:
    @typing.overload
    def __init__(self) -> None:
