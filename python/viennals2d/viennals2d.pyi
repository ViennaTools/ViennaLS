...
class CompareArea:
    ...
    def __init__(*args, **kwargs) -> None: ...
    @staticmethod
    def setLevelSetSample(*args, **kwargs) -> None:
        """
        Sets the sample level set.
        """

    @staticmethod
    def setLevelSetTarget(*args, **kwargs) -> None:
        """
...
class CompareSparseField:
    ...
    def __init__(*args, **kwargs) -> None: ...
    @staticmethod
    def setLevelSetExpanded(*args, **kwargs) -> None:
        """
        Sets the expanded level set for comparison.
        """

    @staticmethod
    def setLevelSetIterated(*args, **kwargs) -> None:
        """
...
class Domain:
    ...
    def __init__(
        ...
        boundaryConditions: typing.Annotated[
            collections.abc.Sequence[...], "FixedSize(2)"
        ],
