...
class CompareArea:
    def __init__(self) -> None: ...
    @overload
    def __init__(self, levelSetTarget: Domain, levelSetSample: Domain) -> None: ...
    def setLevelSetTarget(self, levelSet: Domain) -> None: ...
    def setLevelSetSample(self, levelSet: Domain) -> None: ...
    def setDefaultIncrement(self, increment: int) -> None: ...
    def setXRangeAndIncrement(self, minXRange: int, maxXRange: int, xIncrement: int) -> None: ...
    def setYRangeAndIncrement(self, minYRange: int, maxYRange: int, yIncrement: int) -> None: ...
    def setOutputMesh(self, mesh: Mesh) -> None: ...
    ...
    def apply(self) -> None: ...
    def applyWithMeshOutput(self, mesh: Mesh) -> None: ...
...
class CompareNarrowBand:
    ...
    def setLevelSetTarget(self, levelSet: Domain) -> None: ...
    def setLevelSetSample(self, levelSet: Domain) -> None: ...
    def setXRange(self, minXRange: float, maxXRange: float) -> None: ...
    def setYRange(self, minYRange: float, maxYRange: float) -> None: ...
    def clearXRange(self) -> None: ...
    def clearYRange(self) -> None: ...
    def setOutputMesh(self, mesh: Mesh, outputMeshSquaredDiffs: bool = True) -> None: ...
    def setOutputMeshSquaredDifferences(self, value: bool) -> None: ...
    def apply(self) -> None: ...
    def applyWithMeshOutput(self, mesh: Mesh, outputSquared: bool = True) -> None: ...
