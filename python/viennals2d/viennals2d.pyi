...
class CompareSparseField:
    ...
    def setExpandedLevelSetWidth(self, arg0: int) -> None: ...
    def setXRange(self, arg0: float, arg1: float) -> None: ...
    def setYRange(self, arg0: float, arg1: float) -> None: ...
...
class CompareCriticalDimensions:
    ...
    def apply(self) -> None: ...
    def addXRange(self, minX: float, maxX: float, findMaximum: bool = ...) -> None: ...
    def addYRange(self, minY: float, maxY: float, findMaximum: bool = ...) -> None: ...
    def clearRanges(self) -> None: ...
    def getAllDifferences(self) -> list[float]: ...
    def getCriticalDimensionResult(self, index: int) -> tuple[bool, float, float, float]: ...
    def getMaxDifference(self) -> float: ...
    def getMeanDifference(self) -> float: ...
    def getNumCriticalDimensions(self) -> int: ...
    def getRMSE(self) -> float: ...
    def setLevelSetCompare(self, arg0: Domain) -> None: ...
    def setLevelSetReference(self, arg0: Domain) -> None: ...
    def setOutputMesh(self, arg0: Mesh) -> None: ...
...
class CompareChamfer:
    ...
    def setOutputMeshSample(self, arg0: Mesh) -> None: ...
    def setOutputMeshTarget(self, arg0: Mesh) -> None: ...
