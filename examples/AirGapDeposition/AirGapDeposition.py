...
def run_simulation(kernel, new_layer, total_time, output_interval, name):
    ...
    while passed_time < total_time:
        ...
        vls.ToSurfaceMesh(new_layer, mesh).apply()
...
surfaceMeshBox = vls.ToSurfaceMesh(trench, mesh)
...
surfaceMeshTrench = vls.ToSurfaceMesh(substrate, mesh)
...
multiMeshKernel = vls.ToMultiSurfaceMesh()
